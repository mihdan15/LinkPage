...
// Manage social media links with enable/disable toggles
                ...
                <div className="p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div 
                      ...
                      style={{ backgroundColor: link.isEnabled ? `${config.color}20` : '#e5e7eb' }}
                    >
                      <span style={{ color: link.isEnabled ? config.color : '#9ca3af' }}>
                        {config.icon}
                      </span>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {!isEditing && (
                        <p 
                          className="text-xs text-gray-500 dark:text-gray-400 truncate cursor-pointer hover:text-gray-700 dark:hover:text-gray-300"
                    ...
                    <motion.button
                      ...
                      className={`relative w-10 h-5 rounded-full transition-colors ${
                        link.isEnabled ? '' : 'bg-gray-300 dark:bg-gray-600'
                      }`}
                    ...
                    >
                      <motion.div
                        ...
                        animate={{ left: link.isEnabled ? '1.25rem' : '0.125rem' }}
